...
insert  into `dictionary`(`id`,`dic_code`,`dic_name`,`code_index`,`index_name`,`super_id`,`create_time`) values (1,'sex_types','性别',1,'男',NULL,'2021-03-20 09:24:27'),(2,'sex_types','性别',2,'女',NULL,'2021-03-20 09:24:27'),(3,'politics_types','政治面貌',1,'群众',NULL,'2021-03-20 09:24:27'),(4,'politics_types','政治面貌',2,'党员',NULL,'2021-03-20 09:24:27'),(5,'weisheng_types','卫生状态',1,'优秀',NULL,'2021-03-20 09:24:27'),(6,'weisheng_types','卫生状态',2,'良好',NULL,'2021-03-20 09:24:27'),(7,'weisheng_types','卫生状态',3,'差',NULL,'2021-03-20 09:24:27'),(8,'banji_types','班级',1,'一班',NULL,'2021-03-20 09:24:27'),(9,'banji_types','班级',2,'二班',NULL,'2021-03-20 09:24:27'),(10,'banji_types','班级',3,'三班',NULL,'2021-03-20 09:24:27'),(11,'banji_types','班级',4,'四班',NULL,'2021-03-20 09:24:27'),(13,'zichan_types','资产类型',1,'正常',NULL,'2021-03-20 09:24:27'),(14,'zichan_types','资产类型',2,'异常',NULL,'2021-03-20 09:24:28'),(15,'banji_types','班级',5,'啊啊啊',NULL,'2021-03-22 16:06:20');
...
CREATE TABLE `sushe` (
  ...
  `create_time` timestamp NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='宿舍信息';

/*Data for the table `sushe` */

insert  into `sushe`(`id`,`building`,`unit`,`room`,`sushe_number`,`create_time`) values (1,'9','9','9',2,'2021-03-20 09:24:27'),(2,'9','9','101',8,'2021-03-20 09:24:27'),(3,'公寓1','1','101',0,'2021-03-20 11:45:13'),(4,'公寓2','1','101',1,'2021-03-20 13:21:46'),(5,'公寓3','3','301',1,'2021-03-22 16:01:55');
...
CREATE TABLE `sushe_yonghu` (
  ...
  `create_time` timestamp NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='人员与宿舍关系';

/*Data for the table `sushe_yonghu` */

insert  into `sushe_yonghu`(`id`,`yonghu_id`,`sushe_id`,`create_time`) values (5,9,2,'2021-03-20 09:24:27'),(6,8,2,'2021-03-20 09:24:27'),(7,7,2,'2021-03-20 09:24:27'),(8,6,2,'2021-03-20 09:24:27'),(9,5,2,'2021-03-20 09:24:27'),(10,10,2,'2021-03-20 09:24:27'),(11,4,2,'2021-03-20 09:24:27'),(12,3,2,'2021-03-20 09:24:27'),(13,11,4,'2021-03-20 13:42:30'),(14,12,5,'2021-03-22 16:02:07');
...
CREATE TABLE `token` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=45 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC COMMENT='token表';

/*Data for the table `token` */

insert  into `token`(`id`,`userid`,`username`,`tablename`,`role`,`token`,`addtime`,`expiratedtime`) values (39,6,'admin','users','管理员','ec3gw397hpyb4lupasl00fj0if2z2emt','2021-03-20 09:53:08','2021-03-22 17:12:08'),(40,1,'a1','yonghu','用户','fmo7yr72ht79bytawz56h3tfpsb5b7qp','2021-03-20 13:49:36','2021-03-20 14:49:37'),(41,2,'a2','yonghu','用户','m8b2uvex60rp9u77gb0wqmiq9o0ayyue','2021-03-20 13:51:22','2021-03-22 17:08:41'),(42,7,'a7','yonghu','用户','dz835j05sisv1rkt2aitnxlohskyfquy','2021-03-20 13:51:59','2021-03-20 15:06:37'),(43,12,'a111','yonghu','用户','4yjvnk25vbeiiahvawsk39l8bllwrrqj','2021-03-22 15:44:00','2021-03-22 16:44:00'),(44,8,'a8','yonghu','用户','y74jklir2bfx1uc9l0f6csvbqvlmdg11','2021-03-22 16:08:55','2021-03-22 17:08:55');
...
CREATE TABLE `zichan` (
  ...
  `create_time` timestamp NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=15 DEFAULT CHARSET=utf8 COMMENT='宿舍资产信息';

/*Data for the table `zichan` */

insert  into `zichan`(`id`,`sushe_id`,`zichan_name`,`zichan_types`,`zichan_content`,`create_time`) values (3,2,'桌子',1,'桌子的备注\r\n','2021-03-20 11:16:40'),(4,3,'桌子',1,NULL,'2021-03-20 11:45:13'),(5,3,'空调',1,NULL,'2021-03-20 11:45:13'),(6,3,'板凳',1,NULL,'2021-03-20 11:45:13'),(7,3,'床',2,'思思思思\r\n','2021-03-20 11:45:13'),(8,4,'桌子',1,NULL,'2021-03-20 13:21:46'),(9,4,'空调',1,NULL,'2021-03-20 13:21:46'),(10,5,'桌子',1,NULL,'2021-03-22 16:01:55'),(11,5,'空调',1,NULL,'2021-03-22 16:01:55'),(12,5,'板凳',1,NULL,'2021-03-22 16:01:55'),(13,5,'床',1,NULL,'2021-03-22 16:01:55'),(14,5,'遥控器',1,'','2021-03-22 16:04:43');
